...
trait TransformationsTrait
{
     ...
     * @return int|null
     */
    protected function transformInt($value)
    : ?int
    {
        return intval($value);
    }
     ...
     * @return string
     */
    protected function transformCurrency($value)
    : string
    {
     ...
     * @return float
     */
    protected function transformDouble($value)
    : float
    {
     ...
     * @return string
     */
    protected function transformSkype($value)
    : string
    {
